...
public class UserScrollBarUI extends BasicScrollBarUI {
	...
	private final static Color TRACK_COLOR1 = Color.getColor("grayy", 0XFFDDDDDD),
			TRACK_COLOR2 = Color.getColor("bright gray", 0XFFEEEEEE);
	...
	private final static int BAR_WINDING = 17;//10?
	...
	protected JButton createIncreaseButton(int orientation)//반대쪽 끝 구석의 버튼 하나를 숨깁니다.
	{
	  ...
	  protected void paintTrack(Graphics g, JComponent c, Rectangle r)//스크롤바의 배경화면을 지정합니다.
	  {
		...
		g2.setPaint(TRACK_COLOR1);
		g2.fillRoundRect(r.x, r.y, r.width, r.height, 0, 0);
		g2.setPaint(TRACK_COLOR2);
		g2.fillRoundRect(r.x+10, r.y, r.width, r.height, 0, 0);
	  }
